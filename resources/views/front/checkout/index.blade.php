        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <table class="table your-order-table">
                    ...
                    <tr>
                        <td><img src="{{url('uploads').'/'.$item->model->image}}" alt="{{$item->model->name}}" style="width: 4em"></td>
                        <td>
                            <strong>{{$item->model->name}}</strong><br>
                            {{str_limit($item->model->description,50,'')}}<br>
...
@section('script')
    ...
    <script>
        ...
        var stripe = Stripe('pk_test_6tvXTcNw7dMaKMPnnATEA9dj');
